#--------------------------------------------------------------------------------------------------
#
# FILENAME      :xsetpic.detectlua.cmake
#
# PURPOSE       :DETECT LUA LIBRARY FOR XSETPIC
#
# NOTE          :
#
#                               <perturbed@sina.com>
...
if(XSETPIC_WITH_LUA_OWN_COMPILE)
    message(STATUS "Break Lua Detecting .. (Set 'XSETPIC_WITH_LUA_OWN_COMPILE=${XSETPIC_WITH_LUA_OWN_COMPILE}')")
else()

message(STATUS "Detecting for module 'lua'")
...
if(LUA_FOUND)
    message(STATUS "Found Lua Library , version ${LUA_VERSION_MAJOR}.${LUA_VERSION_MINOR}.${LUA_VERSION_PATCH}")
endif()

endif()

if((NOT XSETPIC_WITH_LUA_OWN_COMPILE) AND (NOT LUA_FOUND))
    message(FATAL_ERROR "\nCmake failed to detect module named 'lua',please check your installation.\nYour Can also try Set 'XSETPIC_WITH_LUA_OWN_COMPILE=ON' to fix the error.\n")
endif()
